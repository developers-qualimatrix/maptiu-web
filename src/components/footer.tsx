      ...
      <div className="container py-8 sm:py-10 lg:py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid gap-8 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
          ...
          <div>
            ...
            <nav className="flex flex-col space-y-2">
              <Link href="/mapIt" className="text-sm text-zinc-400 transition-colors duration-200 hover:text-white">
                Map It
              </Link>
              <Link href="/hire-it" className="text-sm text-zinc-400 transition-colors duration-200 hover:text-white">
                Hire It
              </Link>
              <Link href="/staffIt" className="text-sm text-zinc-400 transition-colors duration-200 hover:text-white">
                Staff It
              </Link>
            </nav>
          </div>
        ...
        <div className="mt-8 sm:mt-12 flex flex-col sm:flex-row items-center justify-between gap-4 border-t border-white/10 pt-6">
          <div className="flex-grow text-center">
            <p className="text-sm text-zinc-400">© 2025 Maptiu. All rights reserved.</p>
          </div>
