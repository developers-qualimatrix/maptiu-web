                    ...
                    <ul className="grid w-[400px] gap-3 bg-white black p-4 lg:w-[500px] lg:grid-cols-2">
                      <li>
                        <NavigationMenuLink asChild>
                          <Link href="/skill-access" className="block rounded-md p-3 hover:bg-zinc-800 hover:text-[#7ED957] text-black">
                            <div className="text-sm font-medium ">SkillAccess</div>
                      ...
                      <li>
                        <NavigationMenuLink asChild>
                          <Link href="/hire-it" className="block rounded-md p-3 hover:bg-zinc-800 hover:text-[#7ED957] text-black">
                      ...
                      <li className="lg:col-span-2">
                        <NavigationMenuLink asChild>
                          <Link href="/resource-augmentation" className="block rounded-md p-3 hover:bg-zinc-800 hover:text-[#7ED957] text-black">
                            <div className="text-sm font-medium ">Resource Augmentation</div>
            ...
            <Sheet>
              ...
              <SheetContent side="right" className="w-[300px] sm:w-[350px] bg-black p-6">
                <nav className="flex flex-col space-y-4">
                  <Link href="/skill-access" className="text-lg font-medium text-white hover:text-[#083B73]">
                    SkillAccess
                  </Link>
                  <Link href="/hire-it" className="text-lg font-medium text-white hover:text-[#083B73]">
                    HireIt
                  </Link>
                  <Link href="/resource-augmentation" className="text-lg font-medium text-white hover:text-[#083B73]">
                    Resource Augmentation
                  </Link>
                  <Link href="/about-us" className="text-lg font-medium text-white hover:text-[#083B73]">
                    About
                  </Link>
                  <Link href="/careers" className="text-lg font-medium text-white hover:text-[#083B73]">
                    Careers
                  </Link>
                  <Link href="/contact-us" className="text-lg font-medium text-white hover:text-[#083B73]">
                    Contact
                  </Link>
                  <div className="pt-4">
                    <Button className="w-full bg-[#083B73] text-white hover:bg-[#083B73]/90" asChild>
                      <Link href="/contact-us">Book Now</Link>
                    </Button>
                  </div>
                </nav>
