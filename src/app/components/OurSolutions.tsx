...
export default function OurSolutions() {
  return(
    <div className="flex flex-col overflow-hidden inset-0 bg-gradient-radial bg-gradient-to-br from-[#9FD6AE] via-[#d1e1d4] to-[#E7F2E9] py-4 sm:py-8 md:py-16">
      <div className="text-center mb-8 md:mb-12">
         <h2 className="text-3xl sm:text-4xl md:text-6xl mt-4 sm:mt-6 md:mt-10 font-bold text-gray-900"
         >Our Solutions</h2>
        <p className="mt-2 sm:mt-4 text-sm sm:text-base md:text-lg text-gray-600 px-4 md:px-0">
          We provide innovative solutions to connect top talent with leading companies.
         </p>
       </div>
      <Link href="https://www.skillaccess.in/">
        <ContainerScroll
          titleComponent={
            <>
              <h1 className="">
                <span className="text-4xl sm:text-3xl md:text-4xl lg:text-[6rem] font-bold mt-1 leading-none pb-2">
                  Skill Access
                </span>
              </h1>
            </>
      ...
      <Link href="/hire-it">
        <ContainerScroll
          titleComponent={
            <>
              <h1 className="">
                <span className="text-4xl sm:text-3xl md:text-4xl lg:text-[6rem] font-bold mt-1 leading-none">
                  HireIt
                </span>
              </h1>
            </>
  ...
  //       {/* Left Column: Skill Access */}
  //       <ContainerScroll
  //         titleComponent={
  //           <h3 className="text-3xl font-bold text-black mb-4">SKILL ACCESS</h3>
  //         }
  //       >
...
//   return (
//     <div className="w-full py-20 bg-[#A5DCB4] text-gray-800 dark:bg-neutral-800 dark:text-white relative">
//       {/* Circular Gradient Overlay */}
//       <div className="absolute inset-0 bg-gradient-radial bg-gradient-to-br from-[#9FD6AE] via-[#d1e1d4] to-[#E7F2E9] z-0" />
      
//       <h2 className="max-w-7xl pl-4 mx-auto text-xl md:text-5xl font-bold text-neutral-800 dark:text-neutral-200 font-sans text-center relative z-10">
//         Our Solutions
//       </h2>
//       <p className="max-w-3xl mx-auto text-lg text-neutral-600 dark:text-neutral-400 text-center mt-6 relative z-10">
//         We provide innovative solutions that connect top talent with leading companies through cutting-edge platforms.
//       </p>
//       <div className="mt-12 flex flex-wrap justify-center relative z-10">
//         {cards}
//       </div>
//     </div>
//   );
