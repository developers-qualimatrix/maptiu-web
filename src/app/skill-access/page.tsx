  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="container mx-auto py-12 md:py-24 px-4 sm:px-6 lg:px-8">
        <h2 className="text-center font-heading text-3xl mb-12">
          How It Works
        </h2>
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <Card className="rounded-md transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
            <CardContent className="p-6">
              ...
              <p className="text-muted-foreground mb-4">
                Streamline admissions with access to pre-assessed student
                profiles.
              </p>
              <ul className="space-y-2">
                <li className="flex items-center gap-2">
          ...
          <Card className="rounded-md transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
            <CardContent className="p-6">
              ...
              <p className="text-muted-foreground mb-4">
                Take AI-proctored assessments and connect with colleges and
                companies.
              </p>
              <ul className="space-y-2">
                <li className="flex items-center gap-2">
          ...
          <Card className="rounded-md transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
            <CardContent className="p-6">
              ...
              <p className="text-muted-foreground mb-4">
                Access pre-assessed candidates and streamline your hiring
                process.
              </p>
              <ul className="space-y-2">
                <li className="flex items-center gap-2">
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              },
              {
                icon: Briefcase,
                title: "Companies",
                description: "Access pre-vetted talent pool",
              },
            ].map((item, index) => (
              <Card
                key={index}
          ...
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              },
              {
                ...
                description:
                  "Seamless integration for universities, colleges, students, and companies",
              },
              {
                icon: Shield,
                title: "Secure Assessments",
                description:
                  "AI-powered proctoring with anti-cheating measures",
              },
              {
                icon: BarChart,
              ...
              >
                <CardContent className="flex flex-col items-center p-6 text-center h-full">
                  ...
                  <h3 className="font-heading text-xl mb-2 text-gray-900">
                    {feature.title}
                  </h3>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <Button
              size="lg"
              variant="outline"
              className="bg-white text-[#083B73] hover:bg-white/90 rounded-md"
            >
