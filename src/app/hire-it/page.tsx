...
import { Search, Users, Briefcase, Clock, CheckCircle, BarChart, Zap, Shield } from "lucide-react"
        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
          <Card className="rounded-md transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
            <CardContent className="p-6 flex flex-col h-full">
              <Search className="h-12 w-12 text-[#FF4500] mb-4" />
          ...
          <Card className="rounded-md transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
            <CardContent className="p-6 flex flex-col h-full">
              <Users className="h-12 w-12 text-[#FF4500] mb-4" />
          ...
          <Card className="rounded-md transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
            <CardContent className="p-6 flex flex-col h-full">
              <Briefcase className="h-12 w-12 text-[#FF4500] mb-4" />
          ...
          {[
            ...
            <Card key={index} className="rounded-md transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
              <CardContent className="p-6 flex flex-col h-full">
                ...
                <Badge className="mb-4 bg-[#FF4500] text-white self-start">{story.result}</Badge>
